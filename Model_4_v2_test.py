...
def load_alphamatting_path(test_alpha):
	...
	fg_path = os.path.join(test_alpha,'merged')
	...
	for i in range(len(images)):
		...
		copy1 = '_'.join(images[i].split('_')[:-1])+'_'+str(num)+'.png'
		fg_images.append(copy1)
...
args['cuda'] = True
args['resume'] ='saved_models_FG_new/model_best.pth.tar'
args['seed'] = 1
# cuda
